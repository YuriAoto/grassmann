...
class ContructExtSpaceTestCase(unittest.TestCase):
    ...
    def test_constr_1(self):
        orb_dim = general.Orbitals_Sets([2], occ_type='R')
        U = [np.zeros((2, 1))]
        U[0][0, 0] = 1.0
    ...
    def test_orbdim_exception(self):
        orb_dim = general.Orbitals_Sets([4], occ_type='R')
        U = [np.zeros((2, 1))]
    ...
    def test_constr_4(self):
        orb_dim = general.Orbitals_Sets([10], occ_type='R')
    ...
    def test_constr_5(self):
        orb_dim = general.Orbitals_Sets([10, 5, 5, 0], occ_type='R')
        U = []
    ...
    def test_constr_7(self):
        orb_dim = general.Orbitals_Sets([6], occ_type='R')
        newU = np.zeros((6, 2))
        newU[3, 0] = 1.0
        newU[5, 1] = 1.0
        U = [newU]
