...
\begin{tikzpicture}[
  ...
  % ======
  \node (end)  at (\X{-30}, \Y{30})
  [startend, text width=\W{3}]{};
  % ------

  % ======
  \node (cc_version)  at (\X{0}, \Y{15})
  ...
  % ======
  \node (inter_matrix_2)  at (\X{35}, \Y{30})
  [algtest, text width=\W{15}, aspect=2]
  {
    \textbf{inter\_matrix}\vspT
  };
  ...
  % ======
  \node (inter_matrix_3)  at (\X{0}, \Y{30})
  ...
  [algstep, text width=\W{30}, hyperlink node=sec:ccsd_res_sing]
  {
    ...
    \texttt{ccsd.equation.\_res\_singles}\vsp
  };
  % ------
  ...
  [algstep, text width=\W{30}, hyperlink node=sec:ccsd_res_doub]
  {
    ...
    \texttt{ccsd.equation.\_res\_doubles}\vsp
  };
  % ------
  ...
  \draw [<-, condFalse] (res.55)  .. controls +(up:1) and +(left:2) .. (inter_matrix_2.180);
  \draw [->] (u_L_matrix.180)  .. controls +(left:1) and +(up:1) .. (res.55);
  \draw [->, condTrue]  (inter_matrix_3.270) -- (u_matrix.90);
  \draw [<-, condFalse] (res.135)  .. controls +(up:1) and +(left:2) .. (inter_matrix_3.180);
  \draw [->] (u_matrix.180)  .. controls +(left:1) and +(up:1) .. (res.135);
