...
CISD_header = ' PROGRAM * CISD (Closed-shell CI(SD))     '\
              + 'Authors: C. Hampel, H.-J. Werner, 1991, M. Deegan, P.J. Knowles, 1992\n'
UCISD_header = ' PROGRAM * CISD (Unrestricted open-shell CI(SD))     '\
               + 'Authors: C. Hampel, H.-J. Werner, 1991, M. Deegan, P.J. Knowles, 1992\n'
RCISD_header = ' PROGRAM * CISD (Restricted open-shell CI(SD))     '\
               + 'Authors: C. Hampel, H.-J. Werner, 1991, M. Deegan, P.J. Knowles, 1992\n'
CCSD_header = ' PROGRAM * CCSD (Closed-shell coupled cluster)     '\
              + 'Authors: C. Hampel, H.-J. Werner, 1991, M. Deegan, P.J. Knowles, 1992\n'
MRCI_header = ' PROGRAM * CI (Multireference internally contracted CI)     '\
